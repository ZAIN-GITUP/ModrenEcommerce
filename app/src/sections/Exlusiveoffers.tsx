...
const ExclusiveOffer: React.FC = () => {
  return (
    <section className="bg-green-100 p-2 sm:p-4 md:p-6 lg:p-8 xl:p-10 flex flex-col lg:flex-row justify-between items-center">
      <div className="text-center lg:text-left mb-4 lg:mb-0 lg:order-1 flex-1">
        ...
        <button className="mt-4 sm:mt-6 lg:mt-8 px-4 py-2 sm:px-6 sm:py-3 bg-green-600 text-white rounded-md text-xs sm:text-sm md:text-base lg:text-lg">
          Buy Now
        </button>
      </div>
